...
loc = loc[0] +"wp-content/themes/dadga/hades_framework/";
...
c.onRenderMenu.add(function(c, m) {
	...
	var sub4 = m.addMenu({title : 'UI', onclick : function() {   }});
		sub4.add({title : 'Error Box', onclick : function() {  tinyMCE.activeEditor.selection.setContent('[error_box title="your title" type="error" ]'+tinyMCE.activeEditor.selection.getContent()+"[/error_box]");  }});
		sub4.add({title : 'Warning Box', onclick : function() {  tinyMCE.activeEditor.selection.setContent('[warning_box title="your title" type="warning"  ]'+tinyMCE.activeEditor.selection.getContent()+"[/warning_box]");  }});
		sub4.add({title : 'Success Box', onclick : function() {  tinyMCE.activeEditor.selection.setContent('[success_box title="your title" type="success"  ]'+tinyMCE.activeEditor.selection.getContent()+"[/success_box]");  }});
		sub4.add({title : 'Information Box', onclick : function() {  tinyMCE.activeEditor.selection.setContent('[information_box title="your title" type="information" ]'+tinyMCE.activeEditor.selection.getContent()+"[/information_box]");  }});
