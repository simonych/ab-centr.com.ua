...
theme_add_sidebar('header', 'header-CONTROL-ID-widget-area', __('Header CONTROL-ID Widget Area', THEME_NS), __("The custom header widget area.", THEME_NS));
theme_add_sidebar('header', 'header-CONTROL-ID-2-widget-area', __('Header CONTROL-ID-2 Widget Area', THEME_NS), __("The custom header widget area.", THEME_NS));
theme_add_sidebar('header', 'header-CONTROL-ID-1-widget-area', __('Header CONTROL-ID-1 Widget Area', THEME_NS), __("The custom header widget area.", THEME_NS));
