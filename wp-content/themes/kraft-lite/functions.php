...
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.net/shop/premium-wordpress-theme/');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-kraft-doc/');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/premium-wordpress-theme/');
