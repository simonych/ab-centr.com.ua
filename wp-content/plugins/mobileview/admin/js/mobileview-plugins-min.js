...
version: "1.0.7",
clients: {},
moviePath: MobileViewCustom.mobileview_url + '/admin/js/ZeroClipboard.swf',
nextId: 1,
$: function(thingy) {
...
function doClcTooltip( selector, tooltip_id, x_offset, y_offset ) {
	jQuery( selector ).live( 'mouseover', function() { 
		...
		jQuery( this ).parent().append( '<div id="mobileview-tooltip" class="round-12" style="display: none; width: 35%;">' + tooltipText + '</div>' );
