<?php 
	...
	$contents = str_replace( '</select>', '<option class="level-0" value="custom"' . $is_custom . '>' . __( "Custom Home Page", "mobileviewlang" ) . '</option></select>', $contents );
	
	echo $contents;
	
?>
<label for="enable_home_page_redirect"><?php _e( "Redirect target", "mobileviewlang" ); ?></label>