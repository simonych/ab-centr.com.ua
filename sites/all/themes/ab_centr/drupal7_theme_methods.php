...
function ab_centr_process_html(&$variables) {
...
function ab_centr_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr_button($variables) {
 ...
 */
function ab_centr_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function ab_centr_menu_local_task($variables) {
 ...
 */
function ab_centr_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr_node_preview($variables) {
  $node = $variables['node'];
