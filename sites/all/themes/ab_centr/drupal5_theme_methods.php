 ...
 * @ingroup themeable
 */
function ab_centr_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function ab_centr_feed_icon($url) {
 ...
 */
function ab_centr_comment_wrapper($content, $type = null) {
  static $node_type;
