...
function menuExtendedCreate() {
    ...
    var styleStr = "";
    var style = jQuery("<style id=\"art-menu-style\"></style>").appendTo('head');
...
jQuery(function ($) {
    ...
    var bgimages = "url('images/object1864393918.png'),url('images/object1989411883.png'),url('images/object1399935282.png'),url('images/object988282451.png'),url('images/object1201519387.png'),url('images/object1537320302.png'), ".split(",");
    var bgpositions = "152px 4px,506px 50px,152px 61px,152px 37px,335px 0px,5px 3px, ".split(",");
...
jQuery(function($) {
    ...
    $('#block-system-main form.art-search #edit-basic input[type="submit"]').insertAfter(text).css('height', 'auto').css('top', parseInt(text.css('top')) + parseInt(text.css('padding-top')));
});
