...
$art_style = '';
$art_head = '';
function ab_centr6spring_process_html(&$variables) {
...
function ab_centr6spring_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr6spring_button($variables) {
 ...
 */
function ab_centr6spring_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function ab_centr6spring_menu_local_task($variables) {
 ...
 */
function ab_centr6spring_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr6spring_node_preview($variables) {
  $node = $variables['node'];
...
*/
function ab_centr6spring_form_alter(&$form, &$form_state, $form_id) {
...
function ab_centr6spring_form_element_label($variables) {
...
function ab_centr6spring_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function ab_centr6spring_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
