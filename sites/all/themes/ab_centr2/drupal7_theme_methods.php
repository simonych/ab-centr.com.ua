...
function ab_centr2_process_html(&$variables) {
...
function ab_centr2_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr2_button($variables) {
 ...
 */
function ab_centr2_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function ab_centr2_menu_local_task($variables) {
 ...
 */
function ab_centr2_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ab_centr2_node_preview($variables) {
  $node = $variables['node'];
