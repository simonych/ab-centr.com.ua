...
function ab_v17_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ab_v17_button($variables) {
 ...
 */
function ab_v17_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function ab_v17_menu_local_task($variables) {
 ...
 */
function ab_v17_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ab_v17_node_preview($variables) {
  $node = $variables['node'];
