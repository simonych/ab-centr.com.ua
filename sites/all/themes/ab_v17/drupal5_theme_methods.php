 ...
 * @ingroup themeable
 */
function ab_v17_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function ab_v17_comment_wrapper($content, $type = null) {
  static $node_type;
