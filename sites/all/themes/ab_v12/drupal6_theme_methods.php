...
function ab_v12_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function ab_v12_feed_icon($url, $title) {
 ...
 */
function ab_v12_preprocess_comment_wrapper(&$vars) {
 ...
 */
function ab_v12_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function ab_v12_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function ab_v12_button($element) {
...
*/
function ab_v12_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function ab_v12_node_preview($node) {
