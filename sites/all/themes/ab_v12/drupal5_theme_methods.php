 ...
 * @ingroup themeable
 */
function ab_v12_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function ab_v12_comment_wrapper($content, $type = null) {
  static $node_type;
