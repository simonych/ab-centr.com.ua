...
function ab_v12_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ab_v12_button($variables) {
 ...
 */
function ab_v12_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function ab_v12_menu_local_task($variables) {
 ...
 */
function ab_v12_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ab_v12_node_preview($variables) {
  $node = $variables['node'];
